package lc.daily.date2206.Q710;
...
class Solution {
    ...
    // boundary把n分成了前半部分和后半部分
    // 前半部分存放白名单数，后半部分存放黑名单数
    // 前半部分的黑名单数映射到后半部分的白名单数
    ...
    private void initMap(int n, int[] blacklist){
        // 黑->白
        b2w = new HashMap<>();
